<div class="k-col-12">
    <?php
    $datas = new HomePage();
    foreach ($datas->getList(12) as $homepage) {?>
        <div class="k-col-2 contentWrapper">
            <h1 class="headerWrapper">
                <?php if(urlArrayPos(1) === ''){ ?>
                <a href="/en/home/view/<?php echo $homepage['ID'];?>"><?php echo substr(strip_tags(strtolower($homepage['Title'])),0,40); ?></a>     
               <?php }else{?>
                <a href="/<?php echo urlArrayPos(1) ?>/<?php echo urlArrayPos(2) ?>/view/<?php echo $homepage['ID'];?>"><?php echo substr(strip_tags(strtolower($homepage['Title'])),0,40); ?></a> 
               <?php }?>
            </h1>
